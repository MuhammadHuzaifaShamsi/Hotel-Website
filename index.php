...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">HA Hotel</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active me-2 h-font" aria-current="page" href="#">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2 h-font" href="#">Rooms</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2 h-font" href="#">Facilities</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2 h-font" href="#">Contact Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link h-font" href="#">About</a>
                    </li>
                </ul>
    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row">
            <div class="col-lg-4 p-4">
                <h3 class="h-font fw-bold fs-3 mb-2">HS Hotel</h3>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum eius possimus voluptatum a asperiores, velit reprehenderit saepe facilis
                     necessitatibus illum molestias aliquam, nostrum assumenda odit unde, maxime libero sequi magni.
                </p>
            </div>
            <div class="col-lg-4 p-4">
            ...
            <div class="col-lg-4 p-4">
                ...
                <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none"><i class="bi bi-twitter me-1"></i>Twitter</a>
                <br>
                <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none"><i class="bi bi-facebook me-1"></i> Facebook</a>
                <br>
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Designed And Developed by HS</h6>
